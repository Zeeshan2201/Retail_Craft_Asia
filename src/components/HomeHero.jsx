...
const HeroSection = () => {
  return (
    <section className="relative flex items-center justify-center h-screen bg-gradient-to-r bg-gray-50 text-center px-6 overflow-hidden">
      ...
      >
        <h1 className="text-5xl font-semibold md:text-6xl mt-4"> 
          Elevate Your <span className="px-2 ">Retail Strategy with</span> 
          <span className="font-bold text-yellow-700 px-2  ">Retail Craft Asia</span>
        </h1>
