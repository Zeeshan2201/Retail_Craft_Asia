    ...
    <main className="min-h-screen bg-sky-50 text-gray-900">
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        <Link
          ...
          className="mt-8 inline-block  text-black px-8 py-3 rounded shadow-sm transition-all duration-300 hover:from-yellow-500 hover:to-yellow-700 hover:shadow-md"
        >
          Get in Touch →
        </Link>
      </section>
