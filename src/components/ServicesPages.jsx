...
//           <div
//             key={index}
//             className="flex flex-row items-center bg-white p-6 border-t-4 border-yellow-500 rounded-lg shadow-md hover:shadow-md hover:shadow-yellow-300 transition-all duration-300 transform hover:scale-105 w-full mx-auto"
//           >
  ...
  return (
    ...
    {/* <main className="min-h-screen bg-gradient-to-b from-gray-50 to-yellow-50 text-gray-900"> */}
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        <Link
          to="/contact"
          className="mt-8 inline-block bg-gradient-to-r hover:from-yellow-500 hover:to-yellow-700 text-black px-8 py-3 rounded-3xl shadow-sm transition-all duration-300 from-yellow-400 to-yellow-600 hover:shadow-md"
        >
          Get in Touch →
        </Link>
      </section>
