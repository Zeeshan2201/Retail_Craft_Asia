  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <h1 className="text-5xl font-bold text-blue-700">Sales & Merchandising</h1>
        <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-700">
          We help brands maximize their market presence by ensuring the right products
          are available at the right time and place.
        </p>
        <Link
          to="/contact"
          className="mt-6 inline-block bg-blue-600 text-white px-6 py-3 rounded-md shadow-md hover:bg-blue-700"
        >
