...
{/* comment */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/SalesAndMerchandising" className="hover:text-white transition-colors flex items-center gap-1">
                Sales and Merchandising
                </Link>
              </li>
              <li>
                <Link to="/services/BrandActivation" className="hover:text-white transition-colors flex items-center gap-1">
                Brand Activation and Experiental Marketing
                </Link>
              </li>
              <li>
                <Link to="/services/MarketExpansion" className="hover:text-white transition-colors flex items-center gap-1">
                Market Expansion Services
                </Link>
              </li>
              <li>
                <Link to="/services/DataAndTechnology" className="hover:text-white transition-colors flex items-center gap-1">
                Data & Technology
                </Link>
              </li>
              <li>
                <Link to="/services/DigitalMarketing" className="hover:text-white transition-colors flex items-center gap-1">
                Digital Marketing
                </Link>
              </li>
            </ul>
